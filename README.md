...
[![My Skills](https://skillicons.dev/icons?i=js,html,css,react,next,vue,svelte,figma,nuxt,ruby,nodejs,tailwind,ts,webpack,vite,py,fastapi,flask,java,spring,php,supabase,gitlab,github,githubactions,firebase,pinia&theme=light)](https://skills.thijs.gg)
